...
import { jsonb, pgTable, text, timestamp, integer, bigint, pgEnum } from "drizzle-orm/pg-core";
...
export const orderItems = pgTable(
  ...
  (table) => [
    sql`INDEX order_items_order_product_idx (${table.orderId}, ${table.productId})`,
    sql`INDEX order_items_variant_id_idx (${table.variantId})`,
  ],
);
