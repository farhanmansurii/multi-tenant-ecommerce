      ...
      <div className="menu-overlay" ref={menuOverlayRef}>
        <div className="menu-overlay-items">
          <div className="menu-overlay-col menu-overlay-col-sm">
            ...
            <div className="menu-main-links">
              ...
              <Link
                href={slug ? `/stores/${slug}/products` : "/stores"}
                className="menu-main-link"
                onClick={handleLinkClick}
              >
                <h4>Wardrobe</h4>
              ...
              <Link
                href={slug ? `/stores/${slug}/account` : "/stores"}
                className="menu-main-link"
                onClick={handleLinkClick}
              >
                <h4>Account</h4>
          ...
          <div className="menu-overlay-col menu-overlay-col-lg">
            <div className="menu-overlay-sub-col">
              ...
              <div className="menu-sub-links">
                <Link
                  href={slug ? `/stores/${slug}/orders` : "/stores"}
                  onClick={handleLinkClick}
                >
                  Orders
                </Link>
                <Link
                  href={slug ? `/stores/${slug}/cart` : "/stores"}
                  onClick={handleLinkClick}
                >
                  Cart
                </Link>
                <Link
                  href={slug ? `/stores/${slug}/contact` : "/stores"}
                  onClick={handleLinkClick}
                >
                  Contact
                </Link>
            ...
            <div className="menu-overlay-sub-col">
              ...
              <div className="menu-sub-links menu-product-links">
                <Link href={slug ? `/stores/${slug}/products` : "/stores"} onClick={handleLinkClick}>
                  Browse Catalog
                </Link>
                <Link href={slug ? `/stores/${slug}` : "/stores"} onClick={handleLinkClick}>
                  Featured
                </Link>
                <Link href={slug ? `/stores/${slug}/checkout` : "/stores"} onClick={handleLinkClick}>
                  Checkout
                </Link>
                <Link href={slug ? `/stores/${slug}/about` : "/stores"} onClick={handleLinkClick}>
                  About
                </Link>
              </div>
            </div>
        ...
        <div className="menu-overlay-footer">
          <div className="menu-social">
            <a
              href={slug ? `/stores/${slug}/about` : "/stores"}
              onClick={handleLinkClick}
            >
              About
            </a>
          ...
          <div className="menu-social">
            {config.contactEmail ? (
              <a href={`mailto:${config.contactEmail}`} onClick={handleLinkClick}>
                Email
              </a>
            ) : null}
          </div>
