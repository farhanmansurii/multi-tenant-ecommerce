    ...
    <div className="peel-reveal-container" ref={peelRevealContainerRef}>
      <section className="peel-reveal">
        <div className="section-header">
          <Copy type="flicker">
            <EditableText as="p" label="Peel reveal header" path="peelReveal.headerLeft" fallback={config.content.peelReveal.headerLeft} />
          </Copy>
          <Copy type="flicker">
            <p>Module ID: {config?.slug || "store"}_001</p>
          </Copy>
        </div>
        <div className="section-footer">
          <Copy type="flicker">
            <EditableText as="p" label="Peel reveal footer status" path="peelReveal.footerStatus" fallback={config.content.peelReveal.footerStatus} />
          </Copy>
        </div>
        <div className="peel-reveal-img-container">
          <div className="pr-img">
            <img
              src={config.content.peelReveal.imageUrl}
              alt="Peel reveal"
            />
          </div>
          <div className="pr-img mask">
            <img src={config.content.peelReveal.imageUrl} alt="" />
          </div>
          <div className="pr-img mask">
            <img src={config.content.peelReveal.imageUrl} alt="" />
          </div>
          ...
          <div className="peel-reveal-header">
            <EditableText as="h1" label="Peel reveal headline" path="peelReveal.headline" fallback={config.content.peelReveal.headline} />
          </div>
        </div>
        <div className="peel-reveal-intro-text-container">
          <div className="peel-reveal-intro-text">
            <EditableText as="h1" label="Peel reveal intro (left)" path="peelReveal.introLeft" fallback={config.content.peelReveal.introLeft} />
          </div>
          <div className="peel-reveal-intro-text">
            <EditableText as="h1" label="Peel reveal intro (right)" path="peelReveal.introRight" fallback={config.content.peelReveal.introRight} />
          </div>
        </div>
      </section>
    </div>
