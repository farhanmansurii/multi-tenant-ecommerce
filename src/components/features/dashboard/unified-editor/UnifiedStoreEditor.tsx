...
import { updateStorefrontDraft, publishStorefrontDraft } from '@/lib/domains/stores/storefront-draft-client';
...
const StorefrontHomeLazy = dynamic(() => import('@/components/storefront-ui/pages/StorefrontHome'), {
  ssr: false,
  loading: () => (
...
function previewThemeFromDraft(store: StoreData, draftMode: StorefrontContentMode, draft: Record<string, unknown>) {
  const baseContent = resolveStorefrontContent({
    ...store,
    settings: {
      ...(store.settings || {}),
      storefrontContentMode: draftMode,
      storefrontContent: draftMode === 'custom' ? draft : (store.settings as any)?.storefrontContent,
    },
  } as any);
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-start justify-between gap-3">
        ...
        {onReset ? (
          <Button type="button" size="sm" variant="ghost" onClick={onReset} disabled={resetDisabled}>
            Reset
          </Button>
        ) : null}
      </div>
	  ...
	  <Form {...form}>
	      <div
	        className={cn(
	          ...
	          isPreviewOn ? "lg:grid-cols-[460px_minmax(0,1fr)]" : "lg:grid-cols-1",
	        )}
	      >
	        ...
	        <div className="rounded-2xl border bg-background p-4 space-y-4">
	          <div className="flex items-center justify-between gap-3">
	            ...
	            <div className="flex items-center gap-3">
	              ...
	              <Button type="button" variant="outline" size="sm" onClick={saveDraft} disabled={draftSaving}>
          ...
          <Separator />
          <Tabs value={draftMode} onValueChange={(v) => { setDraftMode(v as any); setDraftDirty(true); }}>
          ...
          <CardContent className="p-4 space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Shows in the storefront header and metadata.</FormDescription>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Used for SEO and can feed default homepage copy.</FormDescription>
                      <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Accent color for buttons, highlights, and store chrome.</FormDescription>
                        <FormControl>
                          <div>
                            <ColorField
                              label=""
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <FormItem>
                        ...
                        <FormDescription>Controls what customers can use at checkout.</FormDescription>
                        <FormControl>
            ...
            {section === 'home' ? (
              <>
                ...
                <FieldRow label="About headline" onReset={() => resetDraftValue('about.headline')}>
                  <Textarea
                    rows={3}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <FieldRow label="Featured eyebrow" onReset={() => resetDraftValue('featured.eyebrow')}>
                    <Input
                  ...
                  <FieldRow label="Featured CTA label" onReset={() => resetDraftValue('featured.rightCtaLabel')}>
                    <Input
            ...
            {section === 'modules' ? (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <FieldRow label="CTA button label" onReset={() => resetDraftValue('cta.buttonLabel')}>
                    <Input
                ...
                <FieldRow label="Zoom section enabled" hint="Spotlight block on homepage.">
                  <div className="flex items-center justify-between rounded-xl border px-3 py-2">
                    ...
                    <Switch
                      checked={typeof (draft as any).zoomSection?.enabled === 'boolean' ? !!(draft as any).zoomSection.enabled : true}
            ...
            {section === 'pdp' ? (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <FieldRow label="Add to bag label" onReset={() => resetDraftValue('pdp.addToBagLabel')}>
                    <Input
                  ...
                  <FieldRow label="Save item label" onReset={() => resetDraftValue('pdp.saveItemLabel')}>
                    <Input
                ...
                <FieldRow label="Shipping title" onReset={() => resetDraftValue('pdp.shippingTitle')}>
                  <Input
                ...
                <FieldRow label="Shipping body" onReset={() => resetDraftValue('pdp.shippingBody')}>
                  <Textarea
                    rows={3}
