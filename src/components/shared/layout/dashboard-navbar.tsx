    ...
    <header className="sticky top-0 z-40 w-full border-b border-border/40 bg-background/95 backdrop-blur xl:px-0">
      <div className="flex w-full items-center gap-4 px-4 py-3 md:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center gap-3">
          ...
          <Button variant="secondary" className="h-10 px-4 text-sm font-semibold" asChild>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-10 w-10 rounded-full p-0">
                ...
                <span className="absolute -bottom-0.5 right-0 h-2.5 w-2.5 rounded-full border-2 border-background bg-accent" />
              </Button>
            </DropdownMenuTrigger>
