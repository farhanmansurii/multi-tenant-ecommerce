  ...
  ),
  {
    variants: {
      variant: {
        ...
        ghost: cn("hover:bg-muted/50 hover:text-foreground", "dark:hover:bg-muted/30"),
        link: cn("text-foreground underline-offset-4", "hover:underline hover:text-foreground/80"),
        accent: cn(
